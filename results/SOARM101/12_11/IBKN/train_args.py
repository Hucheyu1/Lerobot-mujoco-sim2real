...
class Args:
    ...
    def _add_args(self):
        ...
        self.parser.add_argument("--suffix", type=str, default="12_11", help="实验后缀（用于路径区分）")
        ...
        # 预测参数
        self.parser.add_argument("--pre_length", type=int, default=5, help="预测长度 (默认: 5)")
        ...
        self.parser.add_argument("--batch_size", type=int, default=128, help="训练批次大小 (默认: 128)")
        self.parser.add_argument("--eval_batch_size", type=int, default=128, help="评估批次大小 (默认: 128)")
        self.parser.add_argument(
